        ...
        <Navbar bg="light" expand="lg">
            <Container>
                <Navbar.Brand className={"align-items-center"}>
                    <img src={"https://avatars.githubusercontent.com/u/179946814?s=400&u=cda895bd2aadd6e4be2bcce97ef631b1207afc29&v=4"} alt={"Crupiers"} height={40} width={40}></img>
                ...
                <>
                    {localStorage.getItem("role") === "ADMIN" ?
                        <Button variant={"outline-danger"} className={"me-5 align-items-center d-flex"}>
                            <>
